...
public class AHRS extends IMU {
	...
	private void setAHRSData(AHRSProtocol.AHRSUpdate ahrs_update) {
		synchronized (this) { // synchronized block
			...
			this.is_moving = (((ahrs_update.sensor_status & AHRSProtocol.NAVX_SENSOR_STATUS_MOVING) != 0) ? true
					: false);
			this.is_rotating = (((ahrs_update.sensor_status & AHRSProtocol.NAVX_SENSOR_STATUS_YAW_STABLE) != 0) ? true
					: false);
