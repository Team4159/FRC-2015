					...
					while (i < bytes_read) {
							...
							if ((bytes_remaining > 2) && (received_data[i + 1] == (byte) '#')) {
								...
								while (bytes_remaining < total_expected_binary_data_bytes) {
									...
									if (c.length > 0) {
										...
										System.arraycopy(additional_received_data, 0, c, received_data.length,
										...
										// SmartDashboard.putNumber("nav6
										// Partial Binary Packets",
						...
						if (packet_length > 0) {
							...
							if (packet_length > 0) {
								...
								// SmartDashboard.putNumber("nav6 Stream
								// Responses",
