...
public class ToteLifter {
	...
	public ToteLifter(Victor leftMotor, Victor rightMotor) { // Motor inputs are
																// declared
	...
	public void manualLift(double velocity) { // Moves the elevator WITHOUT
												// regards to the touch sensors
	...
	public void setHighLow(int lowChannel, int topChannel) {
		lowLimit = new DigitalInput(lowChannel); // Sensor input objects
													// declared based on
													// channels
	...
	public void autoLift(double velocity) { // Takes input from sensors to see
											// if they are pressed
		if (velocity > 0) {
